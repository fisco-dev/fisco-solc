...
elseif(EXISTS ${ETH_SOURCE_DIR}/.git)
	execute_process(
	...
	message(STATUS "++git:SOL_COMMIT_HASH:${SOL_COMMIT_HASH}")
# === add default COMMIT HASH
else() 
	execute_process(
		COMMAND echo "68ef5810"
		OUTPUT_VARIABLE SOL_COMMIT_HASH OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET
	)
	execute_process(
		COMMAND echo "68ef5810"
	...
	message(STATUS "===SOL_COMMIT_HASH:${SOL_COMMIT_HASH}")
endif()
